          ...
          <div className={`backdrop-blur-sm border rounded-2xl p-8 md:p-10 shadow-2xl ${
            ...
            <form className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3.5 pr-12 rounded-xl text-base border focus:outline-none focus:ring-2 focus:ring-[#00FF78]/50 focus:border-[#00FF78] shadow-lg transition-all duration-300 hover:border-[#00FF78]/40 ${
                      isDark 
              ...
              <div className="flex justify-end -mt-2">
                <Link to="/forget-password" className={`text-sm transition-colors font-medium ${
